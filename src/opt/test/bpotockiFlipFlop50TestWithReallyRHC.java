 ...
 * @version 1.0
 */
public class bpotockiFlipFlop50TestWithReallyRHC {
    /** The n value */
    ...
    public static void main(String[] args) throws Exception {
        ...
        String filenameStart = "FlipFlop50-";
        ...
        int[] rhcIterations = {1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096};
        //rhcIterations = new int[] {};
        int[] rhcRestartThresholds = {0, 10, 50, 100, 500, 1000};
        //rhcRestartThresholds = new int[] {1000};
        
        int[] saIterations = {1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096};
        //saIterations = new int[] {};
        double[] saInitTemps = {0.1, 1.0, 10.0, 100.0, 1000.0, 10000.0};
        //saInitTemps = new double[] {100.0};
        double[] saDecays = {0.9, 0.99, 0.999, 0.9999};
        //saDecays = new double[] {0.99};
        
        int[] gaIterations = {1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024};
        //gaIterations = new int[] {};
        int[] gaPopSizes = {1000, 2000, 3000};
        //gaPopSizes = new int[] {3000};
        ...
        int[] mmIterations = {1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024};
        //mmIterations = new int[] {};
        int[] mmSamples = {1000, 2000, 3000};
        //mmSamples = new int[] {5000};
	        	...
	        	for (int sample : mmSamples) {
	        		for (double keepPct : mmKeepPercents) {
	                	...
	                	for (int r = 0; r < avgHowManyRuns; r++) {
	        		        ...
	        		        endTime = System.nanoTime();
	        		        duration = (endTime - startTime);
	        		        avgMMOptimals[r] = ef.value(mimic.getOptimal());
