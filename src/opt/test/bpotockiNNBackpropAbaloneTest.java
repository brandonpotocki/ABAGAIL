 ...
 * @version 1.0
 */
public class bpotockiNNBackpropAbaloneTest {
    ...
    private static WeightUpdateRule rule = new RPROPUpdateRule();
    ...
    private static BatchBackPropagationTrainer oa = new BatchBackPropagationTrainer(set, network, measure, rule);
    private static String oaName = "BACKPROP";
    ...
    public static void main(String[] args) throws Exception {
        ...
        CSVUtils.writeLine(nnWriter, Arrays.asList("Algorithm", "Iteration", "Test Size", "Train Time", "Train MSE",
    	...
    	for (int iter : nnIterations) {
	    	...
	    	oa = new BatchBackPropagationTrainer(trainingSet, network, measure, rule);    	
	        ...
	        CSVUtils.writeLine(nnWriter, Arrays.asList(oaName, String.valueOf(iter), String.valueOf(testSize), String.valueOf(trainTrainTime),String.valueOf(trainError/(double)trainingInstances.length),
    ...
    private static double train(BatchBackPropagationTrainer oa, BackPropagationNetwork network, String oaName, int numIters, Instance[] trainInstances) {
    ...
    private static Instance[] initializeInstances() {
        ...
        try {
        	URL abaloneUrl = bpotockiNNBackpropAbaloneTest.class.getResource("abalone.data");
        ...
        for(int i = 0; i < instances.length; i++) {
            ...
            if (cleanedAttributes[i][1][0] <= 9) {
            	countClass0++;
            } else {
            	countClass1++;
            }
        }
        System.out.println("Data split... 0 = " + Integer.toString(countClass0) + "; 1 = " + Integer.toString(countClass1));
