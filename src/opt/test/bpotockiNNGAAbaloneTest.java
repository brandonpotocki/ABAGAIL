 ...
 * @version 1.0
 */
public class bpotockiNNGAAbaloneTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        CSVUtils.writeLine(nnWriter, Arrays.asList("Algorithm", "Iteration", "Pop Size", "Mate Percent", "Mutate Percent",
    	...
    	//nnIterations = new int[] {1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192};
    	//nnIterations = new int[] {16384};
        int[] gaPopSizes = {50, 100, 250};
        //gaPopSizes = new int[] {250};
        double[] gaMatePercents = {0.5, 0.75, 0.95};
        //gaMatePercents = new double[] {0.5};
        double[] gaMutatePercents = {0.1, 0.2};
        //gaMutatePercents = new double[] {0.2};
    		...
    		for (int popSize : gaPopSizes) {
        		for (double matePct : gaMatePercents) {
            		for (double mutPct : gaMutatePercents) {
				    	...
				    	oa = new StandardGeneticAlgorithm(popSize, (int) Math.ceil(matePct * popSize), (int) Math.ceil(mutPct * popSize), nnop);
				        ...
				        results = "\nResults for " + oaName + " [Iteration " + String.valueOf(iter) + "]"
				        		+ "[Pop Size " + String.valueOf(popSize) + "]"
				        		+ "[Mate Percent " + String.valueOf(matePct) + "]"
				        		+ "[Mutate Percent " + String.valueOf(mutPct) + "]:"
				        ...
				        CSVUtils.writeLine(nnWriter, Arrays.asList(oaName, String.valueOf(iter),
				        		String.valueOf(popSize), String.valueOf(matePct), String.valueOf(mutPct),
    ...
    private static Instance[] initializeInstances() {
        ...
        try {
        	URL abaloneUrl = bpotockiNNGAAbaloneTest.class.getResource("abalone.data");
