 ...
 * @version 1.0
 */
public class bpotockiNNRHCAbaloneTest {
    ...
    private static OptimizationAlgorithm oa = new RestartingRandomizedHillClimbing(1000,nnop);
    ...
    public static void main(String[] args) throws Exception {
        ...
        CSVUtils.writeLine(nnWriter, Arrays.asList("Algorithm", "Iteration", "Restart Threshold", "Test Size", "Train Time", "Train MSE",
    	...
    	int[] rhcRestartThresholds = new int[] {0, 1, 10, 100, 1000, 10000};
    	//rhcRestartThresholds = new int[] {1000};
    	...
    	for (int iter : nnIterations) {
    		for (int res : rhcRestartThresholds) {
		    	...
		    	oa = new RestartingRandomizedHillClimbing(res,nnop);
		        ...
		        results = "\nResults for " + oaName + " [Iteration " + String.valueOf(iter) + "]"
		        		+ "[Restart Threshhold " + String.valueOf(res) + "]:"
		        ...
		        CSVUtils.writeLine(nnWriter, Arrays.asList(oaName, String.valueOf(iter), String.valueOf(res), String.valueOf(testSize), String.valueOf(trainTrainTime),String.valueOf(trainError/(double)trainingInstances.length),
    ...
    private static Instance[] initializeInstances() {
        ...
        try {
        	URL abaloneUrl = bpotockiNNRHCAbaloneTest.class.getResource("abalone.data");
