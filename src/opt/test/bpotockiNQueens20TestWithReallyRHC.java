 ...
 * @version 1.0
 */
public class bpotockiNQueens20TestWithReallyRHC {
    /** The n value */
    ...
    public static void main(String[] args) throws Exception {
        ...
        CrossoverFunction cf = new Order1CrossOver();
        Distribution df = new DiscreteDependencyTree(.1); 
        HillClimbingProblem hcp = new GenericHillClimbingProblem(ef, odd, nf);
        GeneticAlgorithmProblem gap = new GenericGeneticAlgorithmProblem(ef, odd, mf, cf);
        ProbabilisticOptimizationProblem pop = new GenericProbabilisticOptimizationProblem(ef, odd, df);
        
        String filenameStart = "NQueens20-";
        ...
        //gaIterations = new int[] {2048};
        int[] gaPopSizes = {500, 1000, 2000};
        //gaPopSizes = new int[] {2000};
        double[] gaMatePercents = {0.75, 0.95};
        ...
        //mmIterations = new int[] {1024, 2048};
        int[] mmSamples = {500, 1000, 2000};
        //mmSamples = new int[] {2000};
        double[] mmKeepPercents = {0.1, 0.2, 0.3};
        //mmKeepPercents = new double[] {0.1};
